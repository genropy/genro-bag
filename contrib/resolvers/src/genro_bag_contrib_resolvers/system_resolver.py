...
"""SystemResolver - Local system information.

Collects platform, Python, user, CPU, disk and network info using only
...
Example:
    ...
    print(bag['system.disk.free_gb'])      # 234.5

    # Include environment variables
    bag['system'] = SystemResolver(include_env=True)
    print(bag['system.env.HOME'])          # '/Users/...'
"""
